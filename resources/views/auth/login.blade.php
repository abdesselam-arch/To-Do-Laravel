        ...
        <div class="card-body login-card-body">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="form-group">
                    <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" required autocomplete="email" autofocus placeholder="{{ trans('login email') }}" name="email" value="{{ old('email', null) }}">
